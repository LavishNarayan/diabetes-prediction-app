...
* Displays whether the person is likely to have diabetes or not
* Provides instant prediction based on input values
...
* Inspiration from real-world healthcare applications
